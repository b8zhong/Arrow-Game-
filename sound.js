/** [p5.sound]  Version: 0.3.12 - 2020-06-26 */
...
(function(modules) {
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(n) {
      "use strict";
      return (
        (n.Signal = function() {
          var t = this.optionsObject(
            arguments,
            ["value", "units"],
            n.Signal.defaults
          );
          (this.output = this._gain = this.context.createGain()),
            (t.param = this._gain.gain),
            n.Param.call(this, t),
            (this.input = this._param = this._gain.gain),
            this.context.getConstant(1).chain(this._gain);
        }),
        n.extend(n.Signal, n.Param),
        (n.Signal.defaults = { value: 0, units: n.Type.Default, convert: !0 }),
        (n.Signal.prototype.connect = n.SignalBase.prototype.connect),
        (n.Signal.prototype.dispose = function() {
          return (
            n.Param.prototype.dispose.call(this),
            (this._param = null),
    ...
    !((__WEBPACK_AMD_DEFINE_RESULT__ = function() {
      ...
      function a(t, e) {
        this.isUndef(t) || 1 === t
          ...
          : 1 < t && (this.input = new Array(t)),
          this.isUndef(e) || 1 === e
            ? (this.output = this.context.createGain())
            : 1 < e && (this.output = new Array(t));
      }
      var e;
      return (
        (a.prototype.set = function(t, e, n) {
          ...
          t: for (var i in t) {
            ...
            var c = r[i];
            this.isUndef(c) ||
              ((a.Signal && c instanceof a.Signal) ||
              (a.Param && c instanceof a.Param)
                ? c.value !== e &&
                  (this.isUndef(n) ? (c.value = e) : c.rampTo(e, n))
        ...
        (a.prototype.get = function(t) {
          ...
          for (var e = {}, n = 0; n < t.length; n++) {
            ...
            this.isObject(t[o])
              ...
              : c instanceof a
              ? (r[o] = c.get())
              : this.isFunction(c) || this.isUndef(c) || (r[o] = c);
          }
          return e;
        }),
        ...
        (a.prototype.connect = function(t, e, n) {
          return (
            Array.isArray(this.output)
              ? ((e = this.defaultArg(e, 0)), this.output[e].connect(t, 0, n))
              : this.output.connect(t, e, n),
            this
          );
        }),
        ...
        (AudioNode.prototype.chain = a.prototype.chain),
        (AudioNode.prototype.fan = a.prototype.fan),
        (a.prototype.defaultArg = function(t, e) {
        ...
        (a.prototype.optionsObject = function(t, e, n) {
          ...
          else for (var i = 0; i < e.length; i++) o[e[i]] = t[i];
        ...
        (a.extend = function(t, e) {
          function n() {}
          a.prototype.isUndef(e) && (e = a),
            (n.prototype = e.prototype),
            (t.prototype = new n()),
            ((t.prototype.constructor = t)._super = e);
        }),
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(i) {
      "use strict";
      return (
        (i.Multiply = function(t) {
          this.createInsOuts(2, 0),
            (this._mult = this.input[0] = this.output = new i.Gain()),
            (this._param = this.input[1] = this.output.gain),
            (this._param.value = this.defaultArg(t, 0));
        }),
        i.extend(i.Multiply, i.Signal),
        (i.Multiply.prototype.dispose = function() {
          return (
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(i) {
      ...
      return (
        (i.Add = function(t) {
          this.createInsOuts(2, 0),
            (this._sum = this.input[0] = this.input[1] = this.output = new i.Gain()),
            (this._param = this.input[1] = new i.Signal(t)),
            this._param.connect(this._sum);
        }),
        i.extend(i.Add, i.Signal),
        (i.Add.prototype.dispose = function() {
          return (
            i.prototype.dispose.call(this),
            this._sum.dispose(),
            (this._sum = null),
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(i) {
      ...
      return (
        (i.Scale = function(t, e) {
          (this._outputMin = this.defaultArg(t, 0)),
            (this._outputMax = this.defaultArg(e, 1)),
            (this._scale = this.input = new i.Multiply(1)),
            (this._add = this.output = new i.Add(0)),
            this._scale.connect(this._add),
            this._setRange();
        }),
        i.extend(i.Scale, i.SignalBase),
        Object.defineProperty(i.Scale.prototype, "min", {
          get: function() {
  ...
  function(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    (function(global) {
      var startaudiocontext__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        22
      );
      var startaudiocontext__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(
        startaudiocontext__WEBPACK_IMPORTED_MODULE_0__
      );
      var Tone_core_Tone__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
      var Tone_core_Tone__WEBPACK_IMPORTED_MODULE_1___default = __webpack_require__.n(
        Tone_core_Tone__WEBPACK_IMPORTED_MODULE_1__
      );
      var Tone_core_Context__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        12
      );
      var Tone_core_Context__WEBPACK_IMPORTED_MODULE_2___default = __webpack_require__.n(
        Tone_core_Context__WEBPACK_IMPORTED_MODULE_2__
      );
      global.TONE_SILENCE_VERSION_LOGGING = true;

      var audiocontext = new window.AudioContext();

      Tone_core_Tone__WEBPACK_IMPORTED_MODULE_1___default.a.setContext(
        audiocontext
      );
      /**
      ...
      p5.prototype.userStartAudio = function(elements, callback) {
        ...
        if (elements instanceof p5.Element) {
          ...
          elements[0] instanceof p5.Element
        ) {
        ...
        return startaudiocontext__WEBPACK_IMPORTED_MODULE_0___default()(
          audiocontext,
          elt,
          callback
        );
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(e) {
      "use strict";
      return (
        (e.WaveShaper = function(e, t) {
          (this._shaper = this.input = this.output = this.context.createWaveShaper()),
            (this._curve = null),
            Array.isArray(e)
              ? (this.curve = e)
              : isFinite(e) || this.isUndef(e)
              ? (this._curve = new Float32Array(this.defaultArg(e, 1024)))
              : this.isFunction(e) &&
                ((this._curve = new Float32Array(this.defaultArg(t, 1024))),
                this.setMap(e));
        }),
        e.extend(e.WaveShaper, e.SignalBase),
        (e.WaveShaper.prototype.setMap = function(e) {
        ...
        Object.defineProperty(e.WaveShaper.prototype, "curve", {
          ...
          set: function(e) {
            (this._curve = new Float32Array(e)),
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(o) {
      "use strict";
      return (
        (o.TimelineSignal = function() {
          var e = this.optionsObject(
            arguments,
            ["value", "units"],
            o.Signal.defaults
          );
          (this._events = new o.Timeline(10)),
            o.Signal.apply(this, e),
            (e.param = this._param),
            o.Param.call(this, e),
            (this._initial = this._fromUnits(this._param.value));
        }),
        o.extend(o.TimelineSignal, o.Param),
        (o.TimelineSignal.Type = {
          Linear: "linear",
        ...
        (o.TimelineSignal.prototype.linearRampToValueAtTime = function(e, t) {
          return (
            ...
            this._param.linearRampToValueAtTime(e, t),
            this
          );
        }),
        (o.TimelineSignal.prototype.exponentialRampToValueAtTime = function(
          e,
          t
        ) {
          t = this.toSeconds(t);
          var i = this._searchBefore(t);
          i && 0 === i.value && this.setValueAtTime(this._minOutput, i.time),
            (e = this._fromUnits(e));
          ...
          return (
            ...
            e < this._minOutput
              ...
              : this._param.exponentialRampToValueAtTime(e, t),
            this
          );
        }),
        (o.TimelineSignal.prototype.setTargetAtTime = function(e, t, i) {
          return (
            ...
            this._param.setTargetAtTime(e, t, i),
            this
          );
        }),
        ...
        (o.TimelineSignal.prototype.setRampPoint = function(e) {
          ...
          if (i && i.time === e)
            ...
            i &&
            i.type === o.TimelineSignal.Type.Curve &&
            i.time + i.duration > e
          )
            ...
            n &&
              ...
              n.type === o.TimelineSignal.Type.Linear
                ? this.linearRampToValueAtTime(t, e)
                : n.type === o.TimelineSignal.Type.Exponential &&
                  this.exponentialRampToValueAtTime(t, e)),
              this.setValueAtTime(t, e);
          }
          return this;
        }),
        (o.TimelineSignal.prototype.linearRampToValueBetween = function(
          e,
          t,
          i
        ) {
        ...
        (o.TimelineSignal.prototype.exponentialRampToValueBetween = function(
          e,
          t,
          i
        ) {
          return (
            this.setRampPoint(t), this.exponentialRampToValueAtTime(e, i), this
          );
        }),
        ...
        (o.TimelineSignal.prototype.getValueAtTime = function(e) {
          ...
          var t = this._searchAfter(e),
            i = this._searchBefore(e),
            n = this._initial;
          if (null === i) n = this._initial;
          else if (i.type === o.TimelineSignal.Type.Target) {
            var a,
              l = this._events.getBefore(i.time);
            (a = null === l ? this._initial : l.value),
              (n = this._exponentialApproach(
                i.time,
                a,
                i.value,
                i.constant,
            ...
            n =
              i.type === o.TimelineSignal.Type.Curve
                ? this._curveInterpolate(i.time, i.value, i.duration, e)
                : null === t
                ? i.value
                : t.type === o.TimelineSignal.Type.Linear
                ? this._linearInterpolate(i.time, i.value, t.time, t.value, e)
                : t.type === o.TimelineSignal.Type.Exponential
        ...
        (o.TimelineSignal.prototype.connect = o.SignalBase.prototype.connect),
        (o.TimelineSignal.prototype._exponentialApproach = function(
          e,
          t,
          i,
          n,
        ...
        (o.TimelineSignal.prototype._linearInterpolate = function(
          e,
          t,
          i,
          n,
        ...
        (o.TimelineSignal.prototype._exponentialInterpolate = function(
          e,
          t,
          i,
          n,
        ...
        (o.TimelineSignal.prototype.dispose = function() {
          o.Signal.prototype.dispose.call(this),
            o.Param.prototype.dispose.call(this),
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(t) {
      return (
        (t.Type = {
          Default: "number",
          Time: "time",
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(i) {
      ...
      return (
        ...
        i.extend(i.Gain),
        (i.Gain.defaults = { gain: 1, convert: !0 }),
        (i.Gain.prototype.dispose = function() {
          i.Param.prototype.dispose.call(this),
        ...
        (i.prototype.createInsOuts = function(t, n) {
          1 === t
            ? (this.input = new i.Gain())
            : 1 < t && (this.input = new Array(t)),
            1 === n
              ? (this.output = new i.Gain())
              : 1 < n && (this.output = new Array(t));
        }),
        i.Gain
      );
    }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)),
      ...
      return (
        (o.Clock = function() {
          ...
          (this.callback = t.callback),
            (this._nextTick = 0),
            (this._lastState = o.State.Stopped),
            (this.frequency = new o.TimelineSignal(
              t.frequency,
              o.Type.Frequency
            )),
            this._readOnly("frequency"),
            (this.ticks = 0),
            (this._state = new o.TimelineState(o.State.Stopped)),
            (this._boundLoop = this._loop.bind(this)),
            this.context.on("tick", this._boundLoop);
        }),
        o.extend(o.Clock, o.Emitter),
        (o.Clock.defaults = {
          callback: o.noOp,
          frequency: 1,
          lookAhead: "auto"
        ...
        (o.Clock.prototype.start = function(t, e) {
          return (
            (t = this.toSeconds(t)),
            this._state.getValueAtTime(t) !== o.State.Started &&
              this._state.add({ state: o.State.Started, time: t, offset: e }),
            this
          );
        }),
        (o.Clock.prototype.stop = function(t) {
          return (
            ...
            this._state.setStateAtTime(o.State.Stopped, t),
            this
          );
        }),
        (o.Clock.prototype.pause = function(t) {
          return (
            (t = this.toSeconds(t)),
            this._state.getValueAtTime(t) === o.State.Started &&
              this._state.setStateAtTime(o.State.Paused, t),
            this
          );
        }),
        (o.Clock.prototype._loop = function() {
          for (
            var t =
              ...
              this.context.updateInterval +
              2 * this.context.lag;
            t > this._nextTick && this._state;
            ...
            if (e !== this._lastState) {
              ...
              e === o.State.Started
                ? ((this._nextTick = i.time),
                  this.isUndef(i.offset) || (this.ticks = i.offset),
                  this.emit("start", i.time, this.ticks))
                : e === o.State.Stopped
                ? ((this.ticks = 0), this.emit("stop", i.time))
                : e === o.State.Paused && this.emit("pause", i.time);
            }
            var s = this._nextTick;
            this.frequency &&
              ((this._nextTick +=
                1 / this.frequency.getValueAtTime(this._nextTick)),
              e === o.State.Started && (this.callback(s), this.ticks++));
          }
        }),
        ...
        (o.Clock.prototype.dispose = function() {
          o.Emitter.prototype.dispose.call(this),
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(o) {
      function t(e, t, n) {
        if (e.input)
          Array.isArray(e.input)
            ? (o.prototype.isUndef(n) && (n = 0), this.connect(e.input[n]))
            : this.connect(e.input, t, n);
        else
          try {
      ...
      return (
        ...
        (o.Context = function(t) {
          for (var e in (o.Emitter.call(this),
        ...
        o.extend(o.Context, o.Emitter),
        o.Emitter.mixin(o.Context),
        (o.Context.prototype._defineProperty = function(e, n) {
          this.isUndef(this[n]) &&
        ...
        Object.defineProperty(o.Context.prototype, "updateInterval", {
          ...
          set: function(t) {
            (this._updateInterval = Math.max(t, o.prototype.blockTime)),
        ...
        o.supported
          ? ((i = AudioNode.prototype.connect),
            (r = AudioNode.prototype.disconnect),
            AudioNode.prototype.connect !== t &&
              ((AudioNode.prototype.connect = t),
              (AudioNode.prototype.disconnect = function(e, t, n) {
                if (e && e.input && Array.isArray(e.input))
                  o.prototype.isUndef(n) && (n = 0),
                    this.disconnect(e.input[n], t, n);
                else if (e && e.input) this.disconnect(e.input, t, n);
                else
                  try {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(n) {
      ...
      return (
        (n.Subtract = function(t) {
          this.createInsOuts(2, 0),
            (this._sum = this.input[0] = this.output = new n.Gain()),
            (this._neg = new n.Negate()),
            (this._param = this.input[1] = new n.Signal(t)),
            this._param.chain(this._neg, this._sum);
        }),
        n.extend(n.Subtract, n.Signal),
        (n.Subtract.prototype.dispose = function() {
          return (
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(o) {
      ...
      return (
        ...
        o.extend(o.Emitter),
        (o.Emitter.prototype.on = function(t, e) {
        ...
        (o.Emitter.prototype.off = function(t, e) {
          for (var i = t.split(/\W+/), r = 0; r < i.length; r++)
            if (((t = i[r]), this._events.hasOwnProperty(t)))
              if (o.prototype.isUndef(e)) this._events[t] = [];
              else
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(c) {
      "use strict";
      return (
        (c.SignalBase = function() {}),
        c.extend(c.SignalBase),
        (c.SignalBase.prototype.connect = function(e, n, a) {
          return (
            (c.Signal && c.Signal === e.constructor) ||
            (c.Param && c.Param === e.constructor) ||
            (c.TimelineSignal && c.TimelineSignal === e.constructor)
              ? (e._param.cancelScheduledValues(0),
                (e._param.value = 0),
                (e.overridden = !0))
              : e instanceof AudioParam &&
                (e.cancelScheduledValues(0), (e.value = 0)),
            c.prototype.connect.call(this, e, n, a),
            this
          );
        }),
        c.SignalBase
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(o) {
      return (
        ...
        o.extend(o.Time, o.TimeBase),
        (o.Time.prototype._unaryExpressions = Object.create(
          o.TimeBase.prototype._unaryExpressions
        )),
        (o.Time.prototype._unaryExpressions.quantize = {
          regexp: /^@/,
          method: function(t) {
        ...
        (o.Time.prototype.quantize = function(t, e) {
          return (
            ...
            (this._expr = function(t, e, o) {
              return (
                (t = t()),
                (e = e.toSeconds()),
                t + (Math.round(t / e) * e - t) * o
              );
        ...
        (o.Time.prototype.copy = function(t) {
          return (
            o.TimeBase.prototype.copy.call(this, t),
            (this._plusNow = t._plusNow),
            this
          );
        }),
        (o.Time.prototype.toNotation = function() {
          var t = this.toSeconds(),
            e = this._toNotationHelper(t, [
              "1m",
              "2n",
              "4n",
              "8n",
        ...
        (o.Time.prototype._toNotationHelper = function(t, e) {
          for (
            var o = this._notationToUnits(e[e.length - 1]), n = "", i = 0;
            i < e.length;
            i++
          ) {
        ...
        (o.Time.prototype._notationToUnits = function(t) {
          for (
            var e = this._primaryExpressions, o = [e.n, e.t, e.m], n = 0;
            n < o.length;
            n++
          ) {
            var i = o[n],
        ...
        (o.Time.prototype.toBarsBeatsSixteenths = function() {
          ...
          return (
            ...
            3 < (n = n.toString()).length && (n = parseFloat(n).toFixed(3)),
            [o, e, n].join(":")
          );
        }),
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(n) {
      return (
        ...
        n.extend(n.TimeBase),
        (n.TimeBase.prototype.set = function(e) {
        ...
        (n.TimeBase.prototype._primaryExpressions = {
          n: {
            regexp: /^(\d+)n/i,
            method: function(e) {
              return 1 === (e = parseInt(e))
                ? this._beatsToUnits(this._timeSignature())
                : this._beatsToUnits(4 / e);
            }
          },
          t: {
            regexp: /^(\d+)t/i,
            method: function(e) {
              return (
                (e = parseInt(e)), this._beatsToUnits(8 / (3 * parseInt(e)))
              );
            }
          },
          m: {
              ...
              return (
                e &&
                  ...
                  (n += this._beatsToUnits(
                    this._timeSignature() * parseFloat(e)
                  )),
                t && "0" !== t && (n += this._beatsToUnits(parseFloat(t))),
                r && "0" !== r && (n += this._beatsToUnits(parseFloat(r) / 4)),
                n
              );
            }
          },
        ...
        (n.TimeBase.prototype._parseBinary = function(e, t) {
          var r;
          this.isUndef(t) && (t = 2),
            (r = t < 0 ? this._parseUnary(e) : this._parseBinary(e, t - 1));
          for (
            var n = e.peek();
            n && this._matchGroup(n, this._binaryExpressions, t);

          )
            (r = (n = e.next()).method.bind(
              this,
              r,
              this._parseBinary(e, t - 1)
            )),
              (n = e.peek());
          return r;
        }),
        (n.TimeBase.prototype._parseUnary = function(e) {
          ...
          return n
            ? ((t = e.next()),
              (r = this._parseUnary(e)),
              n.method.bind(this, r))
            : this._parsePrimary(e);
        }),
        (n.TimeBase.prototype._parsePrimary = function(e) {
          ...
          throw new SyntaxError(
            "Tone.TimeBase: Cannot process token " + t.value
          );
        }),
        ...
        (n.TimeBase.prototype._defaultUnits = "s"),
        (n.TimeBase.prototype._frequencyToUnits = function(e) {
          return 1 / e;
        }),
        ...
        (n.TimeBase.prototype._pushExpr = function(e, t, r) {
          return (
            e instanceof n.TimeBase || (e = new this.constructor(e, r)),
            (this._expr = this._binaryExpressions[t].method.bind(
              this,
              this._expr,
              e._expr
            )),
      ...
      return (
        (a.Param = function() {
          ...
          (this._param = this.input = t.param),
            ...
            this.isObject(t.lfo)
              ? (this.value = t.lfo)
              : this.isUndef(t.value) || (this.value = t.value);
        }),
        a.extend(a.Param),
        (a.Param.defaults = {
        ...
        (a.Param.prototype._minOutput = 1e-5),
        (a.Param.prototype.setValueAtTime = function(t, e) {
          return (
            (t = this._fromUnits(t)),
            (e = this.toSeconds(e)) <= this.now() + this.blockTime
              ? (this._param.value = t)
        ...
        (a.Param.prototype.rampTo = function(t, e, i) {
          return (
            (e = this.defaultArg(e, 0)),
            this.units === a.Type.Frequency ||
            this.units === a.Type.BPM ||
            this.units === a.Type.Decibels
              ? this.exponentialRampToValue(t, e, i)
              : this.linearRampToValue(t, e, i),
            this
          );
        }),
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(i) {
      ...
      return (
        ...
        i.extend(i.Timeline),
        (i.Timeline.defaults = { memory: 1 / 0 }),
        ...
        (i.Timeline.prototype.remove = function(e) {
          if (this._iterating) this._toRemove.push(e);
          else {
        ...
        (i.Timeline.prototype.getBefore = function(e) {
          ...
          if (0 < i && this._timeline[i - 1].time < e)
          ...
          if (1 < this._timeline.length) {
            ...
            if (0 <= i)
              if (this._timeline[i].time === e) {
                for (var t = i; 0 <= t && this._timeline[t].time === e; t--)
                  i = t;
        ...
        (i.Timeline.prototype._iterate = function(e, i, t) {
          (this._iterating = !0),
            ...
            (t = this.defaultArg(t, this._timeline.length - 1));
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(e) {
      "use strict";
      return (
        (e.GreaterThanZero = function() {
          (this._thresh = this.output = new e.WaveShaper(function(e) {
            return e <= 0 ? 0 : 1;
          }, 127)),
            (this._scale = this.input = new e.Multiply(1e4)),
            this._scale.connect(this._thresh);
        }),
        e.extend(e.GreaterThanZero, e.SignalBase),
        (e.GreaterThanZero.prototype.dispose = function() {
          return (
            e.prototype.dispose.call(this),
            this._scale.dispose(),
            (this._scale = null),
    ...
    !(function(e, t) {
      ...
      var r = function(e, t) {
        (this._dragged = !1),
          ...
          (this._bindedEnd = this._ended.bind(this, t)),
          e.addEventListener("touchstart", this._bindedEnd),
          e.addEventListener("touchmove", this._bindedMove),
          e.addEventListener("touchend", this._bindedEnd),
          e.addEventListener("mouseup", this._bindedEnd);
      };
      function o(e) {
        return "running" === e.state;
      }
      return (
        (r.prototype._moved = function(e) {
          this._dragged = !0;
        }),
              ...
              !(function(t, n) {
                o(t)
                  ...
                  : (function e() {
                      o(t)
                        ? n()
                        : (requestAnimationFrame(e), t.resume && t.resume());
                    })();
              })(t, e);
            }),
            d = [];
          return (
            (function e(t, n, i) {
              if (Array.isArray(t) || (NodeList && t instanceof NodeList))
                for (var d = 0; d < t.length; d++) e(t[d], n, i);
              else if ("string" == typeof t)
                e(document.querySelectorAll(t), n, i);
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(i) {
      "use strict";
      return (
        (i.CrossFade = function(e) {
          this.createInsOuts(2, 1),
            (this.a = this.input[0] = new i.Gain()),
            (this.b = this.input[1] = new i.Gain()),
            (this.fade = new i.Signal(
              this.defaultArg(e, 0.5),
              i.Type.NormalRange
            )),
            (this._equalPowerA = new i.EqualPowerGain()),
            (this._equalPowerB = new i.EqualPowerGain()),
            (this._invert = new i.Expr("1 - $0")),
        ...
        i.extend(i.CrossFade),
        (i.CrossFade.prototype.dispose = function() {
          return (
            i.prototype.dispose.call(this),
            this._writable("fade"),
  ...
  function(module, exports) {
    !(function() {
      ...
      "function" != typeof AudioWorkletNode &&
        ((self.AudioWorkletNode = function(e, t, r) {
          var o = f(e)[t],
            n = e.createScriptProcessor(
              void 0,
              2,
              r && r.outputChannelCount ? r.outputChannelCount[0] : 2
            );
          if (((n.parameters = new Map()), o.properties))
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(o) {
      (o.Frequency = function(e, t) {
        ...
        o.extend(o.Frequency, o.TimeBase),
        (o.Frequency.prototype._primaryExpressions = Object.create(
          o.TimeBase.prototype._primaryExpressions
        )),
        (o.Frequency.prototype._primaryExpressions.midi = {
          regexp: /^(\d+(?:\.\d+)?midi)/,
          method: function(e) {
          ...
          return (
            (this._expr = function(e, t) {
              for (var r = e(), n = [], o = 0; o < t.length; o++)
                n[o] = r * this.intervalToFrequencyRatio(t[o]);
              return n;
            }.bind(this, this._expr, e)),
            this
          );
      ...
      return (
        (o.Frequency.A4 = 440),
        (o.Frequency.prototype.midiToFrequency = function(e) {
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(o) {
      return (
        (o.TransportTime = function(t, r) {
          if (!(this instanceof o.TransportTime))
            return new o.TransportTime(t, r);
          o.Time.call(this, t, r);
        }),
        o.extend(o.TransportTime, o.Time),
        (o.TransportTime.prototype._unaryExpressions = Object.create(
          o.Time.prototype._unaryExpressions
        )),
        (o.TransportTime.prototype._unaryExpressions.quantize = {
          regexp: /^@/,
          method: function(t) {
        ...
        (o.TransportTime.prototype.valueOf = function() {
          return (
            this._secondsToTicks(this._expr()) +
            (this._plusNow ? o.Transport.ticks : 0)
          );
        }),
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(p) {
      "use strict";
      function r(e, n, r) {
        var t = new e();
        return (
          r._eval(n[0]).connect(t, 0, 0), r._eval(n[1]).connect(t, 0, 1), t
        );
      }
      function t(e, n, r) {
        var t = new e();
      ...
      return (
        (p.Expr = function() {
          ...
          try {
            ...
            new Error("Tone.Expr: Could evaluate expression: " + n));
          }
          this.output = t;
        }),
        p.extend(p.Expr, p.SignalBase),
        (p.Expr._Expressions = {
          value: {
            signal: {
              regexp: /^\d+\.\d+|^\d+/,
          ...
          func: {
            abs: { regexp: /^abs/, method: t.bind(this, p.Abs) },
            mod: {
              regexp: /^mod/,
              method: function(e, n) {
                var r = i(e[1]),
          ...
          binary: {
            "+": { regexp: /^\+/, precedence: 1, method: r.bind(this, p.Add) },
            "-": {
              regexp: /^\-/,
              precedence: 1,
              method: function(e, n) {
          ...
          unary: {
            "-": { regexp: /^\-/, method: t.bind(this, p.Negate) },
            "!": { regexp: /^\!/, method: t.bind(this, p.NOT) }
          }
        }),
        ...
        (p.Expr.prototype._replacements = function(e) {
          for (var n = e.shift(), r = 0; r < e.length; r++)
            n = n.replace(/\%/i, e[r]);
          return n;
        }),
            ...
            for (var n in p.Expr._Expressions) {
              ...
              for (var t in r) {
                var o = r[t],
                  ...
                  a = e.match(i);
                if (null !== a)
                  return { type: n, value: a[0], method: o.method };
              }
            }
                  ...
                  ? (function e() {
                      ...
                      if (o(n, "unary"))
                        return (
                          (n = t.next()),
                          (r = e()),
                          { operator: n.value, method: n.method, args: [r] }
                        );
                      return s();
                    })()
                  : i(e - 1));
            for (var r = t.peek(); o(r, "binary", e); )
              (n = {
          ...
          function s() {
            ...
            if ("func" === e.type)
              return (function(e) {
                ...
                if (!r(t.next(), "("))
                  throw new SyntaxError(
                    'Tone.Expr: Expected ( in a function call "' + e.value + '"'
                  );
                r(t.peek(), ")") ||
                  (n = (function() {
                    var e,
                      n = [];
                    for (; (e = i()), !a(e) && (n.push(e), r(t.peek(), ",")); )
                      t.next();
                    return n;
                  })());
                if (r(t.next(), ")"))
                  return { method: e.method, args: n, name: name };
                throw new SyntaxError(
                  'Tone.Expr: Expected ) in a function call "' + e.value + '"'
                );
              })((e = t.next()));
            if ("value" === e.type)
              return { method: (e = t.next()).method, args: e.value };
            if (r(e, "(")) {
              if ((t.next(), (n = i()), !r((e = t.next()), ")")))
                throw new SyntaxError("Expected )");
              return n;
            }
            throw new SyntaxError(
              "Tone.Expr: Parse error, cannot process token " + e.value
            );
          }
          return i();
        }),
        ...
        (p.Expr.prototype._disposeNodes = function() {
          for (var e = 0; e < this._nodes.length; e++) {
            var n = this._nodes[e];
            this.isFunction(n.dispose)
              ? n.dispose()
              : this.isFunction(n.disconnect) && n.disconnect(),
              (n = null),
              (this._nodes[e] = null);
          }
          this._nodes = null;
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(e) {
      ...
      return (
        (e.GreaterThan = function(t) {
          this.createInsOuts(2, 0),
            (this._param = this.input[0] = new e.Subtract(t)),
            (this.input[1] = this._param.input[1]),
            (this._gtz = this.output = new e.GreaterThanZero()),
            this._param.connect(this._gtz);
        }),
        e.extend(e.GreaterThan, e.Signal),
        (e.GreaterThan.prototype.dispose = function() {
          return (
            e.prototype.dispose.call(this),
            this._param.dispose(),
            (this._param = null),
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(s) {
      ...
      return (
        ...
        s.extend(s.Abs, s.SignalBase),
        (s.Abs.prototype.dispose = function() {
          return (
      ...
      return (
        (i.Modulo = function(t) {
          this.createInsOuts(1, 0),
            (this._shaper = new i.WaveShaper(Math.pow(2, 16))),
            (this._multiply = new i.Multiply()),
            (this._subtract = this.output = new i.Subtract()),
            (this._modSignal = new i.Signal(t)),
        ...
        i.extend(i.Modulo, i.SignalBase),
        (i.Modulo.prototype._setWaveShaper = function(i) {
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(n) {
      "use strict";
      return (
        (n.AudioToGain = function() {
          this._norm = this.input = this.output = new n.WaveShaper(function(n) {
            return (n + 1) / 2;
          });
        }),
        n.extend(n.AudioToGain, n.SignalBase),
        (n.AudioToGain.prototype.dispose = function() {
          return (
            n.prototype.dispose.call(this),
            this._norm.dispose(),
            (this._norm = null),
  ...
  function(module, exports, __webpack_require__) {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function(e) {
      "use strict";
      return (
        (e.EqualPowerGain = function() {
          this._eqPower = this.input = this.output = new e.WaveShaper(
            function(e) {
              return Math.abs(e) < 0.001 ? 0 : this.equalPowerScale(e);
            }.bind(this),
            4096
          );
        }),
        e.extend(e.EqualPowerGain, e.SignalBase),
        (e.EqualPowerGain.prototype.dispose = function() {
          return (
            e.prototype.dispose.call(this),
  ...
  function(module, __webpack_exports__, __webpack_require__) {
    ...
    function safeBufferSize(idealBufferSize) {
      ...
      var tempAudioWorkletNode = new AudioWorkletNode(
        master.audiocontext,
        processorNames_default.a.soundFileProcessor
      );
    ...
    var moduleSources = [
      __webpack_require__(27)["default"],
      __webpack_require__(28)["default"],
      __webpack_require__(29)["default"]
    ];
          ...
          if (request.status === 200) {
            ...
            soundfile_ac.decodeAudioData(
              ...
              function() {
                ...
                var msg =
                  "AudioContext error at decodeAudioData for " + self.url;
    ...
    p5.SoundFile.prototype.currentTime = function() {
      return this.reversed
        ? Math.abs(this._lastPos - this.buffer.length) / soundfile_ac.sampleRate
        : this._lastPos / soundfile_ac.sampleRate;
    };
    /**
    ...
    p5.SoundFile.prototype.setBuffer = function(buf) {
      ...
      var newBuffer = soundfile_ac.createBuffer(
        numChannels,
        size,
        soundfile_ac.sampleRate
      );
    ...
    var _createCounterBuffer = function _createCounterBuffer(buffer) {
      ...
      var audioBuf = soundfile_ac.createBuffer(
        1,
        buffer.length,
        soundfile_ac.sampleRate
      );
    ...
    p5.Amplitude = function(smoothing) {
      ...
      this._workletNode = new AudioWorkletNode(
        this.audiocontext,
        processorNames_default.a.amplitudeProcessor,
        {
    ...
    Signal_default.a.prototype.fade =
      Signal_default.a.prototype.linearRampToValueAtTime;
    ...
    p5.Oscillator = function(freq, type) {
      ...
      this.oscillator.frequency.setValueAtTime(
        this.f,
        master.audiocontext.currentTime
      );
    ...
    p5.Envelope.prototype.setRampPercentages = function(p1, p2) {
      ...
      TCDenominator = Math.log(1.0 / this._rampLowPercentage);
      this._rampDecayTC =
        this._rampDecayTime / this.checkExpInput(TCDenominator);
    };
    /**
    ...
    p5.Envelope.prototype.add = function(num) {
      ...
      var nextChain = this.output;
      return p5.prototype._mathChain(
        this,
        add,
        thisChain,
        nextChain,
    ...
    var _whiteNoiseBuffer = (function() {
      ...
      var whiteBuffer = master.audiocontext.createBuffer(
        1,
        bufferSize,
        master.audiocontext.sampleRate
      );
    ...
    var _pinkNoiseBuffer = (function() {
      var bufferSize = 2 * master.audiocontext.sampleRate;
      var pinkBuffer = master.audiocontext.createBuffer(
        1,
        bufferSize,
        master.audiocontext.sampleRate
      );
    ...
    var _brownNoiseBuffer = (function() {
      var bufferSize = 2 * master.audiocontext.sampleRate;
      var brownBuffer = master.audiocontext.createBuffer(
        1,
        bufferSize,
        master.audiocontext.sampleRate
      );
    ...
    p5.AudioIn.prototype.start = function(successCallback, errorCallback) {
      ...
      window.navigator.mediaDevices
        ...
        .then(function(stream) {
          ...
          self.mediaStream = master.audiocontext.createMediaStreamSource(
            stream
          );
    ...
    p5.AudioIn.prototype.amp = function(vol, t) {
      if (t) {
        ...
        this.output.gain.linearRampToValueAtTime(
          vol,
          rampTime + master.audiocontext.currentTime
        );
      } else {
        this.output.gain.cancelScheduledValues(master.audiocontext.currentTime);
    ...
    p5.Listener3D.prototype.orientForward = function(
      xValF,
      yValF,
      zValF,
      time
    ...
    p5.Convolver.prototype.addImpulse = function(
      path,
      callback,
      errorCallback
    ) {
    ...
    p5.SoundRecorder = function() {
      ...
      this._workletNode = new AudioWorkletNode(
        soundRecorder_ac,
        processorNames_default.a.recorderProcessor,
        {
    ...
    p5.PolySynth.prototype.noteAttack = function(_note, _velocity) {
      ...
      if (
        this.notes[note] &&
        this.notes[note].getValueAtTime(acTime) !== null
      ) {
